...
val dna_mins = Array.fromList [0.1, 0.1, 4.0, 2.0, 0.3, 0.3, 0.3]
val dna_maxs = Array.fromList [0.6, 0.5, 12.0, 7.0, 1.0, 1.0, 1.0]
...
val moth2 = Array.fromList [0.9, 0.4, 0.4, 0.9, 0.0, 0.9, 0.99]
